(function($) {
	...
	var $theme				= 'light',		// available values: 'light','dark'.
		...
		$loaderStyle		= 'line_with_Dots',			// '' is Default, and the other values are : 'circles', 'spin_Square' ,'large_dots' ,'line_with_Dots' ,'cp-round' ,'cp-pinwheel'  ,'cp-balls' ,'cp-bubble' ,'cp-flip' ,'cp-hue' ,'cp-skeleton' ,'cp-eclipse' ,'cp-boxes' ,'cp-morph' 
